    ...
    public boolean isVisible(CmsWorkplace wp) {
        ...
        if (getLink().equals(getPath(OVERVIEW_FILE))) {
            ...
            try {
                ...
                // ignore
                if (LOG.isErrorEnabled()) {
                    LOG.error(e.getLocalizedMessage(), "Unexpected error: mobb-f1cdc3ee9644a803c012aad67ff74af3");
                }
            }
            ...
            try {
                ...
                // should never happen
                if (LOG.isErrorEnabled()) {
                    LOG.error(e.getLocalizedMessage(), "Unexpected error: mobb-f1ba5666560ef5f6937c83c732732332");
                }
            }
            return visible;
        } else if (getPath().indexOf("/users/edit/") > -1) {
            ...
            try {
                ...
                // should never happen
                if (LOG.isErrorEnabled()) {
                    LOG.error(e.getLocalizedMessage(), "Unexpected error: mobb-a0ab99d6cc7fc57dc93c01e2d28b8fbc");
                }
            }
            return false;
